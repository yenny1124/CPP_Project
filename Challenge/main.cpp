...
int main( ) {
    ...
    amountCents -= (numDollars * cents_per_dollar); // calculate the reminder as balance 
    
    numQuarters = amountCents / cents_per_quarter; // calculate the quotient as number of quarters
    amountCents -= (numQuarters * cents_per_quarter); // calculate the reminder as balance 
    
    numDimes = amountCents / cents_per_dime; // calculate the quotient as number of dimes
    amountCents -= (numDimes * cents_per_dime); // calculate the reminder as balance 
    
    numNickels = amountCents / cents_per_nickel; // calculate the quotient as number of nickels
    amountCents -= (numNickels * cents_per_nickel); // calculate the reminder as balance 
     
    numPennies = amountCents;
    
    // Display change of the amount in cents to the user
    cout << "You can provide this change as follows : " <<endl;
    cout << " Dollars : " << numDollars << endl;  // calculate balance
